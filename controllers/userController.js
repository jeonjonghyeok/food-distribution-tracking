...
export const about = (req, res) => res.render("about-us.html");
export const contact = (req, res) => res.render("contact.html");

export const projects = (req, res) => res.render("projects.html");
export const prodetail = (req, res) => res.render("project-details.html");
